  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <h1 className="text-center text-4xl font-bold">Artikel</h1>
        ...
        <div className="flex items-center max-w-lg">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-600 px-6 md:px-0">
              Banyak cara yang dilakukan sepasang suami istri dalam mengupayakan
              kehamilan. Sebagai cara cepat hamil, idealnya pasangan sama-sama
              mengusahakan untuk hidup seimbang. Mulai dari mengatur pola makan
              dan menjaga kesehatan. Selanjutnya ada juga yang mencoba metode
              kedokteran untuk bisa hamil. Salah satu yang sedang trending
              setahun belakangan ini adalah metode In Vitro Fertilization.
              Pernah dengar nggak Ma? Berikut Popmama.com akan berikan informasi
              selengkapnya mengenai metode In Vitro Fertilization (IVF).
            </p>
