  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <h1 className="text-center text-4xl font-bold">Acara</h1>
      ...
      <div className="py-10 grid md:grid-cols-2 gap-10 lg:gap-20 ">
        <div>
          <img
            ...
            src="https://images.unsplash.com/photo-1633102467628-6511a5129a03?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
            alt="Anniversary"
          />
        </div>
        <div className="flex items-center max-w-lg">
          <div>
            <h2 className="text-2xl md:text-3xl text-center md:text-left font-bold md:max-w-sm">
              Hari Ulang Tahun Klinik Asha ke-15
            </h2>
            <p className="mt-4 text-lg text-gray-600 px-6 md:px-0">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Sapiente, autem distinctio dolorum odit voluptate in quam quasi
              quisquam ut, quos quibusdam veritatis illum debitis harum. Qui
              nostrum suscipit, ratione facere libero ut sunt nisi labore?
              Voluptatem fuga fugiat enim similique?
            </p>
            ...
            events?.map((event) => (
              ...
              >
                ...
                <div className="flex-1 bg-white p-6 flex flex-col justify-between relative">
                  <p className="absolute -top-5 right-2 rounded-full px-4 py-2 shadow-md shadow-primary-500/50 bg-primary-500 text-black font-semibold text-sm flex items-center space-x-2">
